...
extern "C" {
	...
	*/
	...
	/*!
		...
		@~japanese	@return	EStApiCError_t エラーコード
	*/
	STAPI_PCALL(PStApiTL_IStFeatureBag_StoreNodeMapToBag_t)(const PStApiHandle_t pIStFeatureBagHandle, PStApiHandle_t pINodeMapHandle, int MaxNumPersistScriptEntries, int64_t *pnValue);
	...
	*/
	...
	/*!
		...
		@~japanese	@return	EStApiCError_t エラーコード
	*/
	STAPI_PCALL(PStApi_IStReverseConverter_GetIStReverseConverter_t)(const PStApiHandle_t pSourceHandle, PStApiHandle_t pIStReverseConverterHandle);
	...
	*/
	typedef struct _StApi_IStReverseConverter_Functions_t
	{
		...
		*/
		PStApi_IStReverseConverter_GetIStReverseConverter_t	GetIStReverseConverter;
